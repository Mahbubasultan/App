        ...
        {stats.map((stat) => {
          ...
          return (
            <button
              ...
              className="bg-white rounded-3xl shadow-lg border border-gray-100 p-6 hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 text-left group"
            >
              <div className="flex items-start justify-between mb-4">
                <div className={`p-4 rounded-2xl ${stat.iconBg} group-hover:scale-110 transition-transform duration-300 shadow-md`}>
                  <Icon size={28} className={stat.iconColor} />
                </div>
                <TrendingUp size={20} className="text-green-500 opacity-70" />
              </div>
