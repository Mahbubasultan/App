            ...
            <div className="p-4 sm:p-6 space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                <div className="bg-gray-50 rounded-xl p-3 border border-gray-200">
                  ...
                  <p className="text-sm sm:text-base font-semibold text-gray-900">{selectedLoan.date}</p>
                </div>
                <div className="bg-gray-50 rounded-xl p-3 border border-gray-200">
                ...
                <div className="bg-gray-50 rounded-xl p-3 border border-gray-200 sm:col-span-2">
                  <p className="text-xs font-semibold text-gray-600 mb-1">Description</p>
                  <p className="text-sm sm:text-base font-semibold text-gray-900">{selectedLoan.description || 'No description'}</p>
                </div>
              </div>
              ...
              <button
                onClick={() => setIsViewModalOpen(false)}
                className="w-full px-4 py-3 bg-[#0B5D3B] text-white rounded-2xl font-semibold hover:bg-[#094a2e] transition-colors text-sm sm:text-base"
              >
                Close
              </button>
            </div>
