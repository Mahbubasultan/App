...
const mockShares = [
  { id: 1, memberName: 'Jean Baptiste', shareName: 'Emergency Fund', value: 2000, totalContributed: 100000, moneyAssigned: 100000, sharesCount: 50, createdDate: '2023-01-15', status: 'Approved', phone: '+250788123456', email: 'jean@email.com', lastPayment: '2024-01-15' },
  { id: 2, memberName: 'Marie Claire', shareName: 'Education Share', value: 2000, totalContributed: 150000, moneyAssigned: 150000, sharesCount: 75, createdDate: '2023-02-20', status: 'Approved', phone: '+250788234567', email: 'marie@email.com', lastPayment: '2024-01-10' },
  { id: 3, memberName: 'Eric Habimana', shareName: 'Business Capital', value: 2000, totalContributed: 200000, moneyAssigned: 200000, sharesCount: 100, createdDate: '2023-03-10', status: 'Approved', phone: '+250788345678', email: 'eric@email.com', lastPayment: '2024-01-12' },
  { id: 4, memberName: 'Patrick Nkunda', shareName: 'Health Share', value: 2000, totalContributed: 120000, moneyAssigned: 120000, sharesCount: 60, createdDate: '2023-06-05', status: 'Approved', phone: '+250788456789', email: 'patrick@email.com', lastPayment: '2024-01-08' },
  { id: 5, memberName: 'Grace Uwera', shareName: 'Investment Fund', value: 2000, totalContributed: 80000, moneyAssigned: 80000, sharesCount: 40, createdDate: '2024-01-20', status: 'Pending', phone: '+250788567890', email: 'grace@email.com', lastPayment: '2024-01-20' },
  { id: 6, memberName: 'David Mugisha', shareName: 'Emergency Fund', value: 2000, totalContributed: 90000, moneyAssigned: 90000, sharesCount: 45, createdDate: '2023-08-12', status: 'Approved', phone: '+250788678901', email: 'david@email.com', lastPayment: '2024-01-05' },
];

export default function AccountantShares() {
  ...
  const filteredShares = mockShares.filter(share => {
    const matchesSearch = 
      share.memberName.toLowerCase().includes(searchQuery.toLowerCase()) ||
      share.shareName.toLowerCase().includes(searchQuery.toLowerCase());
              ...
              <tbody>
                {paginatedShares.map((share) => (
                  <tr key={share.id} className="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                    ...
                    <td className="py-3 px-4 text-gray-900 text-xs sm:text-sm">{share.shareName}</td>
                    <td className="py-3 px-4 text-[#0B5D3B] font-semibold text-xs sm:text-sm">{share.sharesCount}</td>
            ...
            <div className="p-6 overflow-y-auto touch-pan-y flex-1">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="col-span-full bg-gradient-to-r from-[#0B5D3B]/10 to-blue-50 rounded-xl p-4 border border-[#0B5D3B]/20">
                  <h3 className="text-sm font-bold text-gray-900 mb-3 flex items-center gap-2">
                    <div className="w-8 h-8 bg-[#0B5D3B] rounded-full flex items-center justify-center text-white font-bold">
                      {selectedShare.memberName.charAt(0)}
                    </div>
                    Member Information
                  </h3>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div>
                      ...
                      <p className="text-sm font-bold text-gray-900">{selectedShare.memberName}</p>
                    </div>
                    <div>
                      <p className="text-xs text-gray-600 mb-1">Phone Number</p>
                      <p className="text-sm font-semibold text-gray-900">{selectedShare.phone}</p>
                    </div>
                    <div className="sm:col-span-2">
                      <p className="text-xs text-gray-600 mb-1">Email Address</p>
                      <p className="text-sm font-semibold text-gray-900">{selectedShare.email}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gray-50 rounded-xl p-4 border border-gray-200">
                  ...
                  <p className="text-base font-bold text-gray-900">{selectedShare.shareName}</p>
                </div>
                <div className="bg-gray-50 rounded-xl p-4 border border-gray-200">
                  <p className="text-xs font-semibold text-gray-600 mb-1">Share Value</p>
                  <p className="text-base font-bold text-[#0B5D3B]">{selectedShare.value.toLocaleString()} RWF</p>
                </div>
                <div className="bg-gray-50 rounded-xl p-4 border border-gray-200">
                  <p className="text-xs font-semibold text-gray-600 mb-1">Number of Shares</p>
                  <p className="text-base font-bold text-blue-600">{selectedShare.sharesCount}</p>
                </div>
                <div className="bg-gray-50 rounded-xl p-4 border border-gray-200">
                  <p className="text-xs font-semibold text-gray-600 mb-1">Total Contributed</p>
                  <p className="text-base font-bold text-gray-900">{selectedShare.totalContributed.toLocaleString()} RWF</p>
                </div>
                <div className="bg-gray-50 rounded-xl p-4 border border-gray-200">
                  <p className="text-xs font-semibold text-gray-600 mb-1">Money Assigned</p>
                  <p className="text-base font-bold text-purple-600">{selectedShare.moneyAssigned.toLocaleString()} RWF</p>
                </div>
                <div className="bg-gray-50 rounded-xl p-4 border border-gray-200">
                  <p className="text-xs font-semibold text-gray-600 mb-1">Created Date</p>
                  <p className="text-base font-bold text-gray-900">{selectedShare.createdDate}</p>
                </div>
                <div className="bg-gray-50 rounded-xl p-4 border border-gray-200">
                  <p className="text-xs font-semibold text-gray-600 mb-1">Last Payment</p>
                  <p className="text-base font-bold text-gray-900">{selectedShare.lastPayment}</p>
                </div>
                <div className="bg-gray-50 rounded-xl p-4 border border-gray-200">
                  <p className="text-xs font-semibold text-gray-600 mb-1">Status</p>
                  <span className={`inline-block px-3 py-1.5 rounded-full text-xs font-medium ${getStatusColor(selectedShare.status)}`}>
